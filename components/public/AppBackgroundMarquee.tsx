...
export default function AppBackgroundMarquee({ name }: AppBackgroundMarqueeProps) {
  ...
  return (
    ...
    >
      <div className="absolute left-[-10%] top-[18vh] w-[220%] whitespace-nowrap font-display text-[14vw] font-semibold uppercase leading-[0.78] tracking-[-0.06em] text-brand/[0.015] motion-reduce:animate-none sm:text-[11vw]">
        <div className="animate-marquee">{line + line}</div>
      </div>

      <div className="absolute bottom-[10vh] left-[-18%] hidden w-[220%] whitespace-nowrap font-display text-[13vw] font-semibold uppercase leading-[0.78] tracking-[-0.06em] text-text/[0.015] motion-reduce:animate-none sm:block sm:text-[10vw]">
